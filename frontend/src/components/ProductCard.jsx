...
const ProductCard = ({ product, categoryName }) => {
  const { _id, name, price, images, averageRating } = product;
        ...
        <div className="p-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="bg-sky-700 text-white rounded-full w-8 h-8 flex items-center justify-center hover:bg-blue-600 transition-colors"
            >
